<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
 ...
 class News extends CI_Controller{
    ...
    var $thumbnail_main_pic = 170;
    var $medium_main_pic = 351;
	...
	public function add($id=NULL){
		...
		if ($submit){
			...
			if ($this->form_validation->run()==FALSE){
				...
				$this->MNews->setData($title,$description,$this->session->userdata('user_id'),$result['upload_data']['file_name'],'Berita',$title_eng,$description_eng);
				if ($id){
