...
<?php if($this->session->flashdata('success')):?>
            ...
            <?php endif;?>
                    <div class="panel-body">
                      <form class="form-horizontal tasi-form" method="post" action="<?php echo site_url();?>admin/disposisi/update_disposisi">
                      ...
                      <input type="hidden" name="id_disposisi" class="form-control" value="<?php echo $u->id_disposisi?>">
                          <div class="form-group">
                           ...
                           <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" name="nomor_agenda" id="agenda" class="form-control" value="<?php echo $u->nomor_agenda?>" readonly>
                           </div>
                           </div>
                           <div class="form-group">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="date" name="tanggal_surat" class="form-control" value="<?php echo $u->tanggal_surat?>" readonly>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Sifat</label>
                              <div class="col-sm-10">
                                  <input type="text" name="sifat" class="form-control" value="<?php echo $u->sifat?>" readonly>
                              </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="checkbox" name="keterangan" value="Tanggapan dan Saran"> Tanggapan dan Saran<br/>
                                  <input type="checkbox" name="keterangan" value="Proses Lebih Lanjut"> Proses Lebih Lanjut<br/>
                                  <input type="checkbox" name="keterangan" value="Koordinasi/Konfirmasi"> Koordinasi/Konfirmasi<br/>
                                  <!--<input type="checkbox" name="keterangan"> <input name="keterangan" type="text"> <br/>!-->
                              </div>
                          </div>
                          <div class="form-group">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                 <select name="diteruskan_kepada" class="form-control selectpicker">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                 <select name="diteruskan_kepada1" class="form-control selectpicker">
                                    <option value="" selected="selected">--- Pilih Diteruskan Kepada ---</option>
                                    ...
                                    <option value="Pertanahan" <?php if ($u->diteruskan_kepada1=="Pertanahan"){ echo "selected"; }?>>Pertanahan</option>
                                    </select>
                              </div>
                          </div>
                          <div class="form-group row">
                              <label class="col-sm-2 col-sm-2 control-label"></label>
                              <div class="col-sm-10">
                                 <select name="diteruskan_kepada2" class="form-control selectpicker">
                                    <option value="" selected="selected">--- Pilih Diteruskan Kepada ---</option>
                          ...
                          <div class="form-group row">
                              <label class="col-sm-2 col-sm-2 control-label"></label>
                              <div class="col-sm-10">
                                 <select name="diteruskan_kepada3" class="form-control selectpicker">
                                    <option value="" selected="selected">--- Pilih Diteruskan Kepada ---</option>
