...
<?php if($this->session->flashdata('success')):?>
            ...
            <?php endif;?>
                    <div class="panel-body">
                      <form class="form-horizontal tasi-form" method="post" action="<?php echo site_url();?>admin/jadwal/update_jadwal">
                      ...
                      <input type="hidden" name="id_jadwal" class="form-control" value="<?php echo $u->id_jadwal?>">
                          ...
                          <div class="form-group row">
                            <label class="col-sm-2 col-sm-2 control-label">Nomor Urut</label>
                            <div class="col-sm-10">
                            <input name="id_disposisi" id="agenda" class="form-control" value="<?php echo $u->id_disposisi?>" readonly>
                           </div>
                           </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                               <input name="hari" class="form-control" value="<?php echo $u->hari?>" readonly>
                              </div>
                          </div>
                          <div class="form-group">
